...
declare -A SCRIPTS=(
    ...
    ["deploy-reserve-account-factory"]="script/DeployReserveAccountFactory.s.sol:DeployReserveAccountFactory"
...
usage() {
    ...
    echo "  deploy-loan-router-v2 <deployer> <admin> <fee recipient>"
    echo ""
